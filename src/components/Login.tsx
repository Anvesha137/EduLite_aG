...
import { Users, GraduationCap, UserCog, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">Select a role to view the dashboard</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {roles.map(({ role, title, description, icon: Icon, color }) => (
            <button
              ...
              className={`${color} text-white p-8 rounded-2xl shadow-lg transition-all transform hover:scale-105 hover:shadow-xl`}
            >
